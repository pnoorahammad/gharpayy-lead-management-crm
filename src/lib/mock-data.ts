...
export const LEADS: Lead[] = [
  ...
  { id: "l-1", name: "Karthik R.", phone: "+91 98331 12345", email: "karthik.r@gmail.com", source: "Instagram",
    budget: 14000, moveInDate: iso(addDays(now, 3)), preferredArea: "Koramangala",
    assignedTcmId: "tcm-1", stage: "tour-scheduled", intent: "hot", priority: "high", confidence: 86,
  ...
  { id: "l-5", name: "Mohit J.", phone: "+91 97442 99021", email: "mohit.j@yahoo.com", source: "Instagram",
    budget: 13500, moveInDate: iso(addDays(now, 5)), preferredArea: "Koramangala",
    assignedTcmId: "tcm-1", stage: "tour-done", intent: "hot", priority: "high", confidence: 79,
    tags: ["second-tour"], nextFollowUpAt: iso(at(now, 18)), responseSpeedMins: 4,
    createdAt: iso(addDays(now, -4)), updatedAt: iso(now) },
  { id: "l-8", name: "Divya N.", phone: "+91 95882 22334", email: "divya.n@outlook.com", source: "Referral",
    budget: 15000, moveInDate: iso(addDays(now, 4)), preferredArea: "Koramangala",
    assignedTcmId: "tcm-1", stage: "tour-done", intent: "hot", priority: "medium", confidence: 82,
  ...
  { id: "l-9", name: "Sanjay P.", phone: "+91 99114 41001", email: "sanjay.p@gmail.com", source: "Referral",
    budget: 14500, moveInDate: iso(addDays(now, 2)), preferredArea: "Koramangala",
    assignedTcmId: "tcm-1", stage: "negotiation", intent: "hot", priority: "high", confidence: 88,
  ...
  { id: "l-10", name: "Nitya K.", phone: "+91 98227 71200", email: "nitya.k@gmail.com", source: "Google",
    budget: 13800, moveInDate: iso(addDays(now, 6)), preferredArea: "Koramangala",
    assignedTcmId: "tcm-1", stage: "tour-done", intent: "warm", priority: "medium", confidence: 71,
  ...
  { id: "l-11", name: "Aakash B.", phone: "+91 96551 11008", email: "aakash.b@gmail.com", source: "Instagram",
    budget: 15500, moveInDate: iso(addDays(now, 1)), preferredArea: "Koramangala",
    assignedTcmId: "tcm-1", stage: "negotiation", intent: "hot", priority: "high", confidence: 92,
  ...
  { id: "l-2", name: "Ananya G.", phone: "+91 91225 55310", email: "ananya.g@gmail.com", source: "Justdial",
    budget: 11000, moveInDate: iso(addDays(now, 7)), preferredArea: "Indiranagar",
    assignedTcmId: "tcm-2", stage: "negotiation", intent: "warm", priority: "medium", confidence: 62,
  ...
  { id: "l-6", name: "Riya D.", phone: "+91 93313 14150", email: "riya.d@gmail.com", source: "Housing.com",
    budget: 13500, moveInDate: iso(addDays(now, 2)), preferredArea: "Indiranagar",
    assignedTcmId: "tcm-2", stage: "tour-done", intent: "hot", priority: "high", confidence: 78,
    tags: ["parents-involved"], nextFollowUpAt: null, responseSpeedMins: 5,
    createdAt: iso(addDays(now, -3)), updatedAt: iso(addDays(now, -1)) },
  { id: "l-12", name: "Tanya M.", phone: "+91 90997 03330", email: "tanya.m@gmail.com", source: "Justdial",
    budget: 12000, moveInDate: iso(addDays(now, 9)), preferredArea: "Indiranagar",
    assignedTcmId: "tcm-2", stage: "tour-done", intent: "warm", priority: "medium", confidence: 58,
  ...
  { id: "l-13", name: "Rahul V.", phone: "+91 94881 88250", email: "rahul.v@gmail.com", source: "Google",
    budget: 12500, moveInDate: iso(addDays(now, 12)), preferredArea: "Indiranagar",
    assignedTcmId: "tcm-2", stage: "contacted", intent: "warm", priority: "low", confidence: 51,
    tags: ["needs-tour-2"], nextFollowUpAt: iso(addHours(now, 18)), responseSpeedMins: 11,
    createdAt: iso(addDays(now, -4)), updatedAt: iso(addDays(now, -1)) },
  { id: "l-14", name: "Pranav S.", phone: "+91 92774 44477", email: "pranav.s@gmail.com", source: "Housing.com",
    budget: 11500, moveInDate: iso(addDays(now, 15)), preferredArea: "Indiranagar",
    assignedTcmId: "tcm-2", stage: "tour-done", intent: "warm", priority: "medium", confidence: 64,
  ...
  { id: "l-15", name: "Devika R.", phone: "+91 99883 32210", email: "devika.r@gmail.com", source: "Referral",
    budget: 13000, moveInDate: iso(addDays(now, 6)), preferredArea: "Indiranagar",
    assignedTcmId: "tcm-2", stage: "negotiation", intent: "warm", priority: "high", confidence: 67,
  ...
  { id: "l-3", name: "Vikram S.", phone: "+91 99888 81120", email: "vikram.s@gmail.com", source: "Referral",
    budget: 9000, moveInDate: iso(addDays(now, 14)), preferredArea: "HSR Layout",
    assignedTcmId: "tcm-3", stage: "contacted", intent: "cold", priority: "low", confidence: 38,
  ...
  { id: "l-7", name: "Arjun K.", phone: "+91 98770 01100", email: "arjun.k@gmail.com", source: "Google",
    budget: 12000, moveInDate: iso(addDays(now, 10)), preferredArea: "BTM",
    assignedTcmId: "tcm-3", stage: "new", intent: "warm", priority: "medium", confidence: 48,
    tags: [], nextFollowUpAt: iso(addHours(now, 2)), responseSpeedMins: 14,
    createdAt: iso(addHours(now, -2)), updatedAt: iso(addHours(now, -2)) },
  { id: "l-16", name: "Manish T.", phone: "+91 91660 09900", email: "manish.t@gmail.com", source: "Justdial",
    budget: 10000, moveInDate: iso(addDays(now, 20)), preferredArea: "HSR Layout",
    assignedTcmId: "tcm-3", stage: "contacted", intent: "cold", priority: "low", confidence: 32,
  ...
  { id: "l-17", name: "Reema A.", phone: "+91 95880 02100", email: "reema.a@gmail.com", source: "Google",
    budget: 11500, moveInDate: iso(addDays(now, 8)), preferredArea: "HSR Layout",
    assignedTcmId: "tcm-3", stage: "tour-scheduled", intent: "warm", priority: "medium", confidence: 55,
  ...
  { id: "l-18", name: "Faisal N.", phone: "+91 90113 50000", email: "faisal.n@gmail.com", source: "Instagram",
    budget: 9500, moveInDate: iso(addDays(now, 30)), preferredArea: "HSR Layout",
    assignedTcmId: "tcm-3", stage: "new", intent: "cold", priority: "low", confidence: 28,
  ...
  { id: "l-4", name: "Sneha P.", phone: "+91 90224 68100", email: "sneha.p@gmail.com", source: "Google",
    budget: 16000, moveInDate: iso(addDays(now, 1)), preferredArea: "Whitefield",
    assignedTcmId: "tcm-4", stage: "tour-scheduled", intent: "hot", priority: "high", confidence: 91,
  ...
  { id: "l-19", name: "Ritika G.", phone: "+91 98555 50100", email: "ritika.g@gmail.com", source: "Instagram",
    budget: 14000, moveInDate: iso(addDays(now, 2)), preferredArea: "Whitefield",
    assignedTcmId: "tcm-4", stage: "tour-scheduled", intent: "hot", priority: "high", confidence: 89,
  ...
  { id: "l-20", name: "Harsh V.", phone: "+91 92770 04400", email: "harsh.v@gmail.com", source: "Google",
    budget: 13500, moveInDate: iso(addDays(now, 3)), preferredArea: "Whitefield",
    assignedTcmId: "tcm-4", stage: "tour-done", intent: "hot", priority: "high", confidence: 84,
  ...
  { id: "l-21", name: "Megha B.", phone: "+91 91888 88120", email: "megha.b@gmail.com", source: "Referral",
    budget: 15000, moveInDate: iso(addDays(now, 4)), preferredArea: "Whitefield",
    assignedTcmId: "tcm-4", stage: "negotiation", intent: "hot", priority: "high", confidence: 87,
  ...
  { id: "l-22", name: "Yash D.", phone: "+91 97112 49000", email: "yash.d@gmail.com", source: "Instagram",
    budget: 14500, moveInDate: iso(addDays(now, 5)), preferredArea: "Whitefield",
    assignedTcmId: "tcm-4", stage: "tour-scheduled", intent: "hot", priority: "medium", confidence: 81,
    tags: ["weekend-tour"], nextFollowUpAt: iso(addDays(now, 1)), responseSpeedMins: 3,
    createdAt: iso(addDays(now, -1)), updatedAt: iso(addHours(now, -2)) },
  { id: "l-23", name: "Aanya L.", phone: "+91 99770 07700", email: "aanya.l@gmail.com", source: "Google",
    budget: 16500, moveInDate: iso(addDays(now, 7)), preferredArea: "Whitefield",
    assignedTcmId: "tcm-4", stage: "negotiation", intent: "hot", priority: "high", confidence: 86,
