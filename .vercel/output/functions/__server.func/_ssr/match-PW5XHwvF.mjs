...
import { A as AppShell, ah as scarcity$1, ak as perDayLabel, a8 as PGS, aq as DISTANCE$1, ar as LANDMARKS$1, as as AREA_CENTROID$1 } from "./AppShell-Cp2f_YYK.mjs";
import { u as useApp, q as cn } from "./router-kYRMoTX_.mjs";
import "../_libs/sonner.mjs";
import "../_libs/react-dom.mjs";
import { bC as ArrowLeft, S as Sparkles, y as Target } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-accent font-semibold mb-1", children: "Lead Matcher" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-semibold tracking-tight", children: "Find the best PG for a lead" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Real distance + actual bed prices · never fabricated. Hard-disqualifies on gender / over-budget / occupancy not offered." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: (e) => {
        e.preventDefault();
        setSubmitted(true);
      }, className: "rounded-lg border bg-card p-4 grid grid-cols-1 md:grid-cols-3 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Lead name (optional)", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: lead.name ?? "", onChange: (e) => setLead({
          ...lead,
          name: e.target.value
        }), className: "input" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Wants area / landmark / company", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, value: lead.area, onChange: (e) => setLead({
          ...lead,
          area: e.target.value
        }), placeholder: "e.g. Manyata, Christ, Koramangala", className: "input" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Gender", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: lead.gender, onChange: (e) => setLead({
          ...lead,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Budget min (₹/mo)", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", required: true, value: lead.budgetMin, onChange: (e) => setLead({
          ...lead,
          budgetMin: +e.target.value
        }), className: "input" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Budget max (₹/mo)", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", required: true, value: lead.budgetMax, onChange: (e) => setLead({
          ...lead,
          budgetMax: +e.target.value
        }), className: "input" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Occupancy", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: lead.occupancy, onChange: (e) => setLead({
          ...lead,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Audience", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: lead.audience, onChange: (e) => setLead({
          ...lead,
          audience: e.target.value
        }), className: "input", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Both" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Working" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Student" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Notes", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: lead.notes ?? "", onChange: (e) => setLead({
          ...lead,
          notes: e.target.value
        }), className: "input", placeholder: "Optional" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "submit", className: "inline-flex items-center gap-1 rounded-md bg-accent px-4 py-2 text-sm font-medium text-accent-foreground hover:opacity-90", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4" }),
          " Match"
        ] }) })
      ] }),
      submitted && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: results.map((r) => {
          const rt = rating(r.total);
          const sc = scarcity$1(r.pg);
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/supply-hub/$id", params: {
            id: r.pg.id
          }, className: "block rounded-lg border bg-card p-4 hover:border-accent/50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold mt-0.5", children: r.pg.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: r.pg.locality })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("font-display text-2xl font-semibold", rt.color), children: r.total }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("text-[10px] uppercase tracking-wider font-semibold", rt.color), children: rt.label })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 flex flex-wrap gap-2 text-xs", children: r.parts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: cn("rounded border px-1.5 py-0.5", p.pts >= p.max * 0.7 ? "border-emerald-400/40 bg-emerald-400/10 text-emerald-300" : "border-border text-muted-foreground"), children: [
              p.label,
              ": ",
              p.pts,
              "/",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 grid grid-cols-1 md:grid-cols-3 gap-2 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { k: "Best fit", v: r.bedLabel }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { k: "Commute", v: r.commuteKm !== null ? `${r.commuteKm} km` : "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { k: "Per day", v: r.bedPrice ? perDayLabel(r.bedPrice) : "—" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-xs italic text-muted-foreground", children: r.reasoning }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 text-[10px] uppercase tracking-wider text-accent font-semibold", children: [
              rt.action,
              sc.hot && ` · ${sc.level}`
            ] })
          ] }, r.pg.id);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `.input{width:100%;border:1px solid hsl(var(--border));background:hsl(var(--background));border-radius:6px;padding:8px 10px;font-size:13px}.input:focus{outline:none;box-shadow:0 0 0 2px hsl(var(--accent)/0.3)}` })
  ] });
}
function Field({
  label,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground font-semibold mb-1", children: label }),
    children
  ] });
}
function Cell({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded border border-border bg-muted/20 px-2 py-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: k }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", children: v })
  ] });
}
export {
