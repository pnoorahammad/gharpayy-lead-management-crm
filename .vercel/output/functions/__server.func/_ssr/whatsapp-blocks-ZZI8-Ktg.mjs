...
import { q as cn, a7 as OFFICE_PHONE } from "./router-kYRMoTX_.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { b as Check, j as Copy } from "../_libs/lucide-react.mjs";
function CopyChipRail({ blocks, dense }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("flex flex-wrap gap-1.5", dense && "gap-1"), children: blocks.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      onClick: () => copy(b),
      title: b.text,
      ...
      children: [
        copied === b.key ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "h-3 w-3" }),
        b.label,
        b.internal && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase opacity-60", children: "int" })
      ]
    },
    b.key
  )) });
