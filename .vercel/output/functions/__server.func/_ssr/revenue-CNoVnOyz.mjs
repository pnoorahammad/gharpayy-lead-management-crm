...
import { I as IndianRupee, T as TrendingUp, d as Users, B as Building2 } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-2xl font-semibold tracking-tight inline-flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { className: "h-6 w-6 text-success" }),
        " Revenue"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Live MRR closed, broken down by closer, property, and source." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: "MRR closed", value: `₹${(totalMRR / 1e3).toFixed(0)}k`, sub: `${bookings.length} booking${bookings.length === 1 ? "" : "s"}`, accent: "success" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: "Last 7 days", value: `₹${(last7 / 1e3).toFixed(0)}k`, sub: prev7 > 0 ? `${wow >= 0 ? "+" : ""}${wow}% WoW` : "—", accent: wow >= 0 ? "success" : "destructive" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: "Top closer", value: byTcm[0] ? tcms.find((t) => t.id === byTcm[0].tcmId)?.name?.split(" ")[0] ?? "—" : "—", sub: byTcm[0] ? `₹${(byTcm[0].revenue / 1e3).toFixed(0)}k` : "", accent: "accent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: "Top property", value: byProperty[0] ? properties.find((p) => p.id === byProperty[0].propertyId)?.name ?? "—" : "—", sub: byProperty[0] ? `${byProperty[0].bookings} booking${byProperty[0].bookings === 1 ? "" : "s"}` : "" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-xl border border-border bg-card overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between px-4 py-3 border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-sm font-semibold", children: "30-day MRR trend" })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: trend.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground text-center py-8", children: "Loading…" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-1 h-32", children: trend.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center gap-1 group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full relative", style: {
          height: `${t.amt / maxTrend * 100}%`,
          minHeight: t.amt > 0 ? "4px" : "0"
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-success/70 group-hover:bg-success rounded-sm transition-colors" }) }),
        i % 5 === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-mono text-muted-foreground", children: t.day.split(" ")[1] })
      ] }, i)) }) })
    ] }),
...
function Tile({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `font-display text-xl font-semibold mt-1 ${cls}`, children: value }),
...
function Breakdown({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-xl border border-border bg-card overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "divide-y divide-border", children: [
      rows.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 text-xs text-center text-muted-foreground", children: "No bookings yet." }),
      rows.map((r) => {
        const pct = total > 0 ? Math.round(r.value / total * 100) : 0;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium truncate", children: r.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground truncate", children: r.sub })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm font-mono font-semibold", children: [
                "₹",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-success", style: {
            width: `${pct}%`
          } }) })
        ] }, r.label);
      })
