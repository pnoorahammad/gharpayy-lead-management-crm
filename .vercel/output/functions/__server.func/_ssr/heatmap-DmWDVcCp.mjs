...
import { O as MapPin, av as CircleAlert, v as TrendingDown, T as TrendingUp } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-2xl font-semibold tracking-tight inline-flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-6 w-6 text-accent" }),
        " Demand heatmap"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Where the market is hot and where you're leaking. Strategic, not operational." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3", children: [
      rows.map((r) => {
        ...
        const Icon = cfg.icon;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-xl border ${cfg.border} ${cfg.bg} p-4 space-y-3`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-semibold", children: r.area }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `inline-flex items-center gap-1 text-[11px] font-medium mt-0.5 ${cfg.text}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: "Pressure" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-sm font-semibold", children: r.pressure })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 text-[11px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Leads", value: r.leads, hot: r.hotLeads }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Tours", value: r.tours }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Booked", value: r.bookings, mono: true }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Conv %", value: `${r.conversion}%`, mono: true }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Vacant", value: `${r.vacantBeds}/${r.totalBeds}`, mono: true }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Avg ₹", value: r.avgBudget ? `${(r.avgBudget / 1e3).toFixed(0)}k` : "—", mono: true })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-full ${r.insight.tone === "hot" ? "bg-destructive" : r.insight.tone === "warm" ? "bg-success" : r.insight.tone === "cold" ? "bg-warning" : "bg-muted-foreground"}`, style: {
            width: `${r.pressure}%`
          } }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground leading-snug", children: r.insight.detail })
        ] }, r.area);
      }),
      rows.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-full rounded-xl border border-border bg-card p-12 text-center text-sm text-muted-foreground", children: "No area data yet." })
    ] })
  ] }) });
}
function Stat({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md bg-background/60 px-2 py-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `text-xs font-medium ${mono ? "font-mono" : ""}`, children: [
      value,
      hot !== void 0 && hot > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1 text-destructive font-mono text-[10px]", children: [
        "·",
        hot,
        "🔥"
      ] })
