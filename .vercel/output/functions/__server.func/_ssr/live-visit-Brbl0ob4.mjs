...
import { A as AppShell, G as Sheet, H as SheetContent, J as SheetHeader, M as SheetTitle } from "./AppShell-qrUFATK5.mjs";
import { u as useApp, c as useMountedNow, X as Input, S as Select, w as SelectTrigger, x as SelectValue, y as SelectContent, z as SelectItem, T as Tabs, h as TabsList, j as TabsTrigger, l as TabsContent, C as Card, Z as Dialog, _ as DialogTrigger, k as Button, $ as DialogContent, a0 as DialogHeader, a1 as DialogTitle, U as Label, q as cn, B as Badge, A as Textarea, a3 as glueBus } from "./router-Brs45mHz.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { c as create, p as persist } from "../_libs/zustand.mjs";
import { C as Checkbox } from "./checkbox-C7zaySDn.mjs";
import { S as Slider } from "./slider-BkIGaRIX.mjs";
import { S as Separator } from "./separator-BWKrsKfl.mjs";
import "../_libs/react-dom.mjs";
import { ae as LayoutGrid, F as Flame, af as ShieldAlert, G as Gauge, ag as BookOpen, t as Plus, R as Radio, h as Siren, b as Check, P as Phone, r as MessageCircle, O as MapPin, k as CircleCheck, w as Shield, g as TriangleAlert, ah as Timer, c as User, B as Building2, s as Clock, ai as Sparkle, aj as Circle, j as Copy, A as ArrowRight, i as FileText, ak as Handshake, W as Wallet, al as Flag } from "../_libs/lucide-react.mjs";
...
const useLiveVisits = create()(
  persist(
    (set, get) => {
      ...
      const advance = (v, stage, by = "System") => {
      ...
      return {
        ...
        patch: (id, p, note) => mut(id, (v) => note ? log({ ...v, ...p }, entry(note.kind, note.text, note.by)) : { ...v, ...p }),
        setStage: (id, stage, by) => mut(id, (v) => advance(v, stage, by)),
        setConfirmation: (id, status, by = "Visit Controller") => mut(id, (v) => {
        ...
        setMovement: (id, m, etaAt, by = "Visit Controller") => mut(id, (v) => {
          let next = log(
        ...
        toggleInventory: (id, key, by = "Supply Controller") => mut(id, (v) => {
        ...
        confirmAllInventory: (id, by = "Supply Controller") => mut(id, (v) => {
          const inv = {
            roomVacant: true,
            bedAvailable: true,
            roomCleaned: true,
        ...
        toggleReadiness: (id, key, by = "Tour Coordinator") => mut(id, (v) => {
        ...
        confirmCoordinator: (id, by = "Visit Controller") => mut(id, (v) => log({ ...v, coordinatorConfirmed: true }, entry("readiness", `${v.coordinator} confirmed availability`, by))),
        reassignCoordinator: (id, coordinatorId, coordinator, by = "Visit Controller") => mut(
          id,
          (v) => log(
        ...
        captureFeedback: (id, f, by = "Tour Coordinator") => mut(id, (v) => {
          const next = log(
        ...
        sendQuotation: (id, q, by = "Lead Owner") => mut(id, (v) => {
        ...
        acceptQuotation: (id, by = "Lead Owner") => mut(id, (v) => {
        ...
        startNegotiation: (id, topics, owner, discount, note) => mut(id, (v) => {
          const next = log(
        ...
        setOutcome: (id, outcome, opts) => mut(id, (v) => {
        ...
        setNextAction: (id, action, by = "Visit Controller") => mut(
          id,
        ...
        setBedAvailable: (id, available, by = "Supply Controller") => mut(
          id,
          (v) => log(
        ...
        setAlternateProperty: (id, name, by = "Visit Controller") => mut(id, (v) => log({ ...v, alternateProperty: name }, entry("note", `Alternate option added: ${name}`, by))),
        ...
        reschedule: (id, at, reason, by = "Visit Controller") => mut(id, (v) => {
          const next = log(
        ...
        cancelVisit: (id, reason, by = "Visit Controller") => mut(id, (v) => {
          const next = log(
        ...
        resolveAlert: (id) => set((s) => ({ alerts: s.alerts.map((a) => a.id === id ? { ...a, resolvedAt: Date.now() } : a) })),
        markAlertsSeen: () => set({ alertsSeenAt: Date.now() }),
        removeVisit: (id) => set((s) => {
          const next = { ...s.visits };
          delete next[id];
          return { visits: next };
        }),
...
const LiveVisitCard = reactExports.memo(function LiveVisitCard2({
  visit: v,
  now,
  onOpen,
  compact
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm truncate", children: v.customer }),
              v.walkIn && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[9px] px-1", children: "WALK-IN" })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: cn("text-[9px] shrink-0", TIER_CHIP[prio.tier]), children: TIER_LABEL[prio.tier].split("·").pop()?.trim() })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[11px]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: cn("ml-auto font-semibold tabular-nums", probTone(prob)), children: [
            prob,
            "%"
          ] })
        ] }),
        !compact && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-2 gap-y-0.5 text-[10.5px] text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 truncate", children: [
          ...
          v.feedback && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "truncate", children: [
            "Rating ",
            v.feedback.rating,
            "/10"
          ] }),
        ...
        objection && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-[10.5px] text-warning-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-3 w-3" }),
          "Objection: ",
          OBJECTION_LABEL[objection],
          objection === "price" && v.rent > v.budget && ` · gap ${inr(v.rent - v.budget)}`
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10.5px] text-muted-foreground line-clamp-1", children: v.nextAction ? `Next: ${v.nextAction.text} (${v.nextAction.owner})` : prio.reasons[0] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1 pt-0.5", onClick: (e) => e.stopPropagation(), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: "h-6 px-2 text-[10px]", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${v.phone}`, onClick: () => logComms(v.id, `Called ${v.customer}`), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-3 w-3 mr-1" }),
            "Call"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: "h-6 px-2 text-[10px]", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", className: "h-6 px-2 text-[10px]", onClick: () => shareLocation(v.id), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3 w-3 mr-1" }),
            "Location"
          ] }),
          v.stage === "scheduled" || v.stage === "customer-confirmed" || v.stage === "inventory-confirmed" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", className: "h-6 px-2 text-[10px]", onClick: () => setMovement(v.id, "en-route"), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-3 w-3 mr-1" }),
            "En route"
          ] }) : null,
          v.stage === "arrived" && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: "h-6 px-2 text-[10px]", onClick: () => startTour(v.id), children: "Start tour" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "secondary", className: "h-6 px-2 text-[10px]", onClick: () => onOpen(v.id), children: "Open" })
        ] })
      ]
    }
  );
...
const FLOW_STEPS = [
  {
    ...
    cx: (v) => `Hi ${v.customer}, your Gharpayy visit is confirmed for ${time(v.scheduledAt)} at ${v.propertyName}, ${v.propertyArea}.
...
Your host will be ${v.coordinator}. Reply YES to lock this slot.`
  ...
  },
  {
    ...
    cx: (v) => `${v.customer}, ${v.coordinator} will receive you today at ${v.propertyName} at ${time(v.scheduledAt)}. Please save this number and call directly on arrival.`
  },
  {
    id: "location",
    ...
    cx: (v) => `Location for your ${time(v.scheduledAt)} visit:
...
Host: ${v.coordinator}. See you soon!`
  ...
  },
  {
    ...
    cx: (v) => `Thanks for visiting ${v.propertyName}, ${v.customer}! How did you like the room? If it works, I'll send you the quotation right away and hold the bed for you.`
  },
  {
    id: "quotation",
...
Valid till ${new Date(q.expiresAt).toLocaleString("en-IN")}. Shall I block it?`;
  ...
  },
  {
    ...
    cx: (v) => `${v.customer}, to block Room ${v.roomNo || ""}${v.bedNo ? `/${v.bedNo}` : ""} at ${v.propertyName} please pay the token of ${inr(v.token?.amount ?? v.quotation?.tokenAmount ?? 5e3)}. Once paid, the bed is locked in your name and no one else can take it.`
  },
  {
    id: "outcome",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border bg-card p-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkle, { className: "h-3.5 w-3.5 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold", children: "Guided flow" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-[10px] ml-auto", children: [
          bookingProbability(v),
          "% likely"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-primary transition-all", style: { width: `${flow.progress}%` } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 grid gap-1", children: flow.steps.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: cn(
          ...
          children: [
            s.status === "done" ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-3.5 w-3.5 text-success shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Circle, { className: cn("h-3.5 w-3.5 shrink-0", s.status === "current" && "text-primary") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 truncate", children: s.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] text-muted-foreground", children: s.owner }),
            s.status !== "done" && now > s.dueAt && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", className: "text-[9px] h-4 px-1", children: "late" })
          ]
        },
        s.id
      )) })
    ] }),
    v.tourStartedAt && !v.completedAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-success/40 bg-success/10 p-3 flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "h-4 w-4 text-success animate-pulse" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold", children: "Visit happening now — admin is watching live" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto font-mono text-sm tabular-nums", children: fmtDur(now - v.tourStartedAt) })
    ] }),
    closed || !step ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border bg-card p-4 text-center space-y-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-6 w-6 text-success mx-auto" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: "Flow complete" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
        "Outcome: ",
        v.outcome ? OUTCOME_LABEL[v.outcome] : "—",
        v.nextAction ? ` · Next: ${v.nextAction.text}` : ""
      ] })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border-2 border-primary/40 bg-primary/5 p-4 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-7 w-7 rounded-full bg-primary text-primary-foreground grid place-items-center text-xs font-bold shrink-0", children: flow.doneCount + 1 }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: step.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: step.why }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Timer, { className: cn("h-4 w-4 ml-auto shrink-0", now > step.dueAt ? "text-destructive" : "text-muted-foreground") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StepAction, { visit: v, stepId: step.id, alternatives })
    ] }),
    message && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border bg-card p-3 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-3.5 w-3.5 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold", children: "Message to send the customer" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { value: message, onChange: (e) => setCxDraft(e.target.value), className: "text-xs min-h-24" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-8 text-xs w-full", onClick: sendCx, children: [
  ...
  switch (stepId) {
    case "confirm-customer":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: btn, onClick: () => store.setConfirmation(v.id, "confirmed"), children: "Customer confirmed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: btn, onClick: () => store.setConfirmation(v.id, "not-responding"), children: "Not responding" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: btn, onClick: () => store.setConfirmation(v.id, "reschedule-requested"), children: "Wants reschedule" })
      ] });
    case "inventory":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-1", children: INVENTORY_CHECK_ITEMS.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-[11px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Checkbox, { checked: !!v.inventory[i.key], onCheckedChange: () => store.toggleInventory(v.id, i.key) }),
          i.label
        ] }, String(i.key))) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: btn, onClick: () => store.confirmAllInventory(v.id), children: "Confirm all — bed is sellable" })
      ] });
    case "coordinator":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: btn, onClick: () => store.confirmCoordinator(v.id), children: [
        v.coordinator,
        " confirmed for this visit"
      ] });
    case "location":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: btn, onClick: () => store.shareLocation(v.id), children: "Mark location pack shared" });
    case "movement":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: btn, onClick: () => store.setMovement(v.id, "en-route", Date.now() + 25 * 6e4), children: "Customer en-route" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: btn, onClick: () => store.setMovement(v.id, "leaving-shortly"), children: "Leaving shortly" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: btn, onClick: () => store.setMovement(v.id, "running-late"), children: "Running late" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "destructive", className: btn, onClick: () => store.setMovement(v.id, "unable-to-come"), children: "Cannot come" })
      ] });
    case "arrival":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", min: 1, value: people, onChange: (e) => setPeople(Number(e.target.value)), className: "h-8 text-xs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: accompanied, onValueChange: (x) => setAccompanied(x), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: ["alone", "family", "friend", "partner"].map((x) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: x, className: "text-xs", children: x }, x)) })
          ] })
        ] }),
    ...
    case "start-tour":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: btn, onClick: () => {
      ...
      }, children: "Start tour timer (notifies admin)" });
    case "reaction":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        intervention && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border bg-background p-2 text-[11px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: intervention.headline }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: intervention.recommendation })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: REACTION_TAGS$1.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: "h-7 text-[10px]", onClick: () => store.addReaction(v.id, t), children: REACTION_META[t].label }, t)) })
      ] });
    case "feedback":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-16", children: "Rating" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { value: [rating], min: 0, max: 10, step: 1, onValueChange: ([x]) => setRating(x), className: "flex-1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono w-8 text-right", children: [
            rating,
            "/10"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: objection, onValueChange: (x) => setObjection(x), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Objection" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "none", className: "text-xs", children: "No objection" }),
            Object.keys(OBJECTION_LABEL).map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: o, className: "text-xs", children: OBJECTION_LABEL[o] }, o))
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "What they liked", value: liked, onChange: (e) => setLiked(e.target.value), className: "h-8 text-xs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: btn, onClick: () => {
        ...
        }, children: "Close tour with feedback" })
      ] });
    case "quotation":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: btn, onClick: () => {
    ...
    case "token":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        !v.token?.promisedAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: btn, onClick: () => store.acceptQuotation(v.id), children: "Customer willing to book" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: btn, onClick: () => store.startNegotiation(v.id, ["price"], v.leadOwner, 0, "Negotiation opened from flow"), children: "Open negotiation" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Payment reference", value: ref, onChange: (e) => setRef(e.target.value), className: "h-8 text-xs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: btn, disabled: !ref.trim(), onClick: () => store.collectToken(v.id, ref.trim()), children: "Token received" })
        ] })
      ] });
    case "outcome":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: outcome, onValueChange: (x) => setOutcome(x), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: Object.keys(OUTCOME_LABEL).map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: o, className: "text-xs", children: OUTCOME_LABEL[o] }, o)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: action, onChange: (e) => setAction(e.target.value), className: "h-8 text-xs", placeholder: "Next action" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: btn, onClick: () => {
        ...
        }, children: "Lock outcome + next action" })
      ] });
    default:
      return null;
  }
...
function VisitControlSheet({
  ...
  const store = useLiveVisits();
  if (!v) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open: !!v, onOpenChange: (o) => {
    if (!o) onClose();
  }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "right", className: "w-full sm:max-w-2xl overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetHeader, { className: "space-y-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetTitle, { className: "flex items-center gap-2 text-base", children: [
        v.customer,
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[10px]", children: STAGE_LABEL[v.stage] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-[10px]", children: [
          bookingProbability(v),
          "% likely"
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: "h-7 text-xs", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${v.phone}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-3 w-3 mr-1" }),
        "Call customer"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: "h-7 text-xs", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `https://wa.me/${v.phone.replace(/\D/g, "")}`, target: "_blank", rel: "noreferrer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-3 w-3 mr-1" }),
        "WhatsApp"
      ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: "h-7 text-xs", onClick: () => store.logComms(v.id, `Coordinator ${v.coordinator} called`), children: "Call coordinator" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "flow", className: "w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid grid-cols-7 h-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "flow", className: "text-[11px]", children: "Flow" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "live", className: "text-[11px]", children: "Live" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "timeline", className: "text-[11px]", children: "T-60" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "tour", className: "text-[11px]", children: "Tour" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "close", className: "text-[11px]", children: "Close" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "rules", className: "text-[11px]", children: "Rules" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "log", className: "text-[11px]", children: "Log" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "flow", className: "pt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NextStepFlow, { visit: v, now, alternatives }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "live", className: "space-y-4 pt-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Confirmation & movement", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Customer confirmation", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: v.confirmation, onValueChange: (x) => store.setConfirmation(v.id, x), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: ["pending", "confirmed", "reschedule-requested", "cancelled", "not-responding"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s, className: "text-xs", children: s.replace(/-/g, " ") }, s)) })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Movement (T−30)", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: v.movement, onValueChange: (x) => store.setMovement(v.id, x), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: ["unknown", "en-route", "leaving-shortly", "running-late", "unable-to-come", "not-responding"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s, className: "text-xs", children: s.replace(/-/g, " ") }, s)) })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: v.coordinatorConfirmed ? "secondary" : "outline", className: "h-7 text-xs", onClick: () => store.confirmCoordinator(v.id), children: v.coordinatorConfirmed ? "Coordinator confirmed" : "Confirm coordinator" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { onValueChange: (id) => {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-7 text-xs w-44", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Change coordinator" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: coordinators.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: c.id, className: "text-xs", children: c.name }, c.id)) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: v.bedAvailable ? "outline" : "destructive", className: "h-7 text-xs", onClick: () => store.setBedAvailable(v.id, !v.bedAvailable), children: v.bedAvailable ? "Flag bed unavailable" : "Restore bed availability" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "T−120 inventory confirmation (Supply Controller)", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-1", children: INVENTORY_CHECK_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-xs py-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Checkbox, { checked: !!v.inventory[item.key], onCheckedChange: () => store.toggleInventory(v.id, item.key) }),
            item.label
          ] }, String(item.key))) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", className: "h-7 text-xs", onClick: () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "T−10 property readiness (Tour Coordinator)", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-1", children: READINESS_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-xs py-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Checkbox, { checked: !!v.readiness[item.key], onCheckedChange: () => store.toggleReadiness(v.id, item.key) }),
          item.label
        ] }, String(item.key))) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrivalBlock, { visit: v }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SchedulingBlock, { visit: v })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "timeline", className: "space-y-2 pt-3", children: checkpointsFor(v).map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("rounded-lg border p-2.5", c.done ? "border-success/40 bg-success/5" : "border-border"), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: c.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: cn("text-[9px]", c.done ? "text-success border-success/40" : "text-muted-foreground"), children: c.done ? "DONE" : "PENDING" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-0.5", children: c.detail }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground mt-0.5", children: [
          "Owner: ",
          c.owner
        ] })
      ] }, c.key)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "tour", className: "space-y-4 pt-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Live reactions (tap as it happens)", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: REACTION_TAGS.map((tag) => {
          ...
          v.tourStartedAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground", children: [
            "Tour running ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: v.reactions.slice(0, 6).map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-muted-foreground", children: [
            "· ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(InterventionBlock, { visit: v, alternatives }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackBlock, { visit: v })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "close", className: "space-y-4 pt-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(QuotationBlock, { visit: v }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NegotiationBlock, { visit: v }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TokenBlock, { visit: v }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(OutcomeBlock, { visit: v })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "rules", className: "space-y-2 pt-3", children: auditRules(v, now).length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-success/40 bg-success/5 p-3 text-xs text-success flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-4 w-4" }),
        " All non-negotiable visit rules satisfied."
      ] }) : auditRules(v, now).map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-destructive/40 bg-destructive/5 p-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-medium text-destructive flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-3.5 w-3.5" }),
          r.rule
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-0.5", children: r.detail })
      ] }, i)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "log", className: "space-y-2 pt-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(NoteComposer, { visit: v }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
        v.timeline.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground tabular-nums shrink-0", children: new Date(t.ts).toLocaleTimeString("en-IN", { hour: "2-digit", minute: "2-digit" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground shrink-0", children: t.by }),
...
function Section({ title, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[11px] font-semibold uppercase tracking-wide text-muted-foreground", children: title }),
    children
  ] });
}
function Field({ label, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10.5px] text-muted-foreground", children: label }),
    children
  ] });
}
function ArrivalBlock({ visit: v }) {
  ...
  if (v.arrival) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Arrival", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-success/40 bg-success/5 p-2.5 text-xs", children: [
        "Arrived ",
      ...
      !v.tourStartedAt && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: "h-7 text-xs", onClick: () => store.startTour(v.id), children: "Start tour (T+10)" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "T+0 arrival capture", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "People visiting", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", min: 1, value: people, onChange: (e) => setPeople(Number(e.target.value)), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Accompanied by", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: withWhom, onValueChange: (x) => setWithWhom(x), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: ["alone", "family", "friend", "partner"].map((x) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: x, className: "text-xs", children: x }, x)) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Any immediate issue?", value: issue, onChange: (e) => setIssue(e.target.value), className: "h-8 text-xs" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: "h-7 text-xs", onClick: () => store.setOutcome(v.id, "no-show", { note: "Customer did not show" }), children: "Mark no-show" }),
...
function SchedulingBlock({ visit: v }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Reschedule / cancel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "datetime-local", value: when, onChange: (e) => setWhen(e.target.value), className: "h-8 text-xs" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Reason", value: reason, onChange: (e) => setReason(e.target.value), className: "h-8 text-xs" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
...
function InterventionBlock({ visit: v, alternatives }) {
  ...
  if (!iv) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-warning/50 bg-warning/5 p-3 space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs font-semibold text-warning-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4" }),
      iv.headline,
      " — live closing intervention"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-0.5", children: iv.lines.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-[11px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: l.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: l.value })
    ] }, l.label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] font-medium", children: [
      "Recommended action: ",
      iv.recommendation
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: "h-7 text-xs", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${v.phone}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-3 w-3 mr-1" }),
        "Call customer"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", className: "h-7 text-xs", onClick: () => {
...
function FeedbackBlock({ visit: v }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "T+20 preference capture (mandatory)", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Favourite property", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: fav, onChange: (e) => setFav(e.target.value), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Favourite room / bed", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: room, onChange: (e) => setRoom(e.target.value), className: "h-8 text-xs" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: `Customer rating: ${rating}/10`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { value: [rating], min: 0, max: 10, step: 1, onValueChange: ([x]) => setRating(x) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: ratingBand }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "What they liked", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: liked, onChange: (e) => setLiked(e.target.value), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "What they disliked", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: disliked, onChange: (e) => setDisliked(e.target.value), className: "h-8 text-xs" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Main objection", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: objection, onValueChange: (x) => setObjection(x), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "none", className: "text-xs", children: "None" }),
          Object.keys(OBJECTION_LABEL).map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: o, className: "text-xs", children: OBJECTION_LABEL[o] }, o))
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Final decision-maker", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: dm, onChange: (e) => setDm(e.target.value), className: "h-8 text-xs" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "What is stopping the booking?", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: blocker, onChange: (e) => setBlocker(e.target.value), className: "h-8 text-xs" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { placeholder: "Objection detail / customer's exact words", value: note, onChange: (e) => setNote(e.target.value), className: "text-xs min-h-[60px]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        size: "sm",
...
function QuotationBlock({ visit: v }) {
  ...
  if (v.quotation?.sentAt) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Quotation", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-info/40 bg-info/5 p-3 text-xs space-y-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Rent", value: inr(v.quotation.rent) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Deposit", value: inr(v.quotation.deposit) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Maintenance", value: inr(v.quotation.maintenance) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Gharpayy fee", value: inr(v.quotation.gharpayyFee) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Check-in", value: v.quotation.checkInDate }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Lock-in / notice", value: `${v.quotation.lockInMonths} months / ${v.quotation.noticeDays} days` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Token", value: inr(v.quotation.tokenAmount) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Offer expires", value: new Date(v.quotation.expiresAt).toLocaleString("en-IN") })
      ] }),
      !v.quotation.acceptedAt ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: "h-7 text-xs", onClick: () => {
          store.acceptQuotation(v.id);
          toast.success("Customer willing to book — token pending");
        }, children: "Customer willing to book" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: "h-7 text-xs", onClick: () => store.setStage(v.id, "negotiation"), children: "Move to negotiation" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-success", children: "Accepted — token conversation started." })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "T+30 quotation", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Room", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: q.roomNo, onChange: (e) => setQ({ ...q, roomNo: e.target.value }), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Bed", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: q.bedNo, onChange: (e) => setQ({ ...q, bedNo: e.target.value }), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Rent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: q.rent, onChange: (e) => setQ({ ...q, rent: Number(e.target.value) }), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Deposit", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: q.deposit, onChange: (e) => setQ({ ...q, deposit: Number(e.target.value) }), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Maintenance", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: q.maintenance, onChange: (e) => setQ({ ...q, maintenance: Number(e.target.value) }), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Gharpayy fee", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: q.gharpayyFee, onChange: (e) => setQ({ ...q, gharpayyFee: Number(e.target.value) }), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Check-in date", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", value: q.checkInDate?.slice(0, 10), onChange: (e) => setQ({ ...q, checkInDate: e.target.value }), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Token amount", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: q.tokenAmount, onChange: (e) => setQ({ ...q, tokenAmount: Number(e.target.value) }), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Lock-in (months)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: q.lockInMonths, onChange: (e) => setQ({ ...q, lockInMonths: Number(e.target.value) }), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Notice (days)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: q.noticeDays, onChange: (e) => setQ({ ...q, noticeDays: Number(e.target.value) }), className: "h-8 text-xs" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground", children: [
      "Move-in total: ",
      inr(total + q.deposit),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-7 text-xs", onClick: () => {
...
function NegotiationBlock({ visit: v }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "T+45 negotiation (Lead Owner)", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: NEGOTIATION_TOPICS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        size: "sm",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Discount offered (₹)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: discount, onChange: (e) => setDiscount(Number(e.target.value)), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Owner", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: v.leadOwner, readOnly: true, className: "h-8 text-xs" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { placeholder: "Negotiation note", value: note, onChange: (e) => setNote(e.target.value), className: "text-xs min-h-[56px]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-7 text-xs", disabled: !topics.length, onClick: () => {
      store.startNegotiation(v.id, topics, v.leadOwner, discount, note);
      toast.success("Negotiation logged");
    }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Handshake, { className: "h-3 w-3 mr-1" }),
      "Log negotiation"
    ] })
  ] });
}
function TokenBlock({ visit: v }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Token", children: v.token?.paidAt ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-success/40 bg-success/5 p-2.5 text-xs text-success", children: [
    "Token ",
    inr(v.token.amount),
    " received · ref ",
    v.token.reference,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Token amount", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: amount, onChange: (e) => setAmount(Number(e.target.value)), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Payment reference", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: ref, onChange: (e) => setRef(e.target.value), className: "h-8 text-xs" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", className: "h-7 text-xs", onClick: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-7 text-xs", disabled: !ref, onClick: () => {
        store.collectToken(v.id, ref);
        toast.success("Token collected — BOOKED");
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "h-3 w-3 mr-1" }),
        "Collect token & book"
      ] })
    ] })
  ] }) });
...
function OutcomeBlock({ visit: v }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "T+60 final outcome + next action (mandatory)", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Outcome", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: outcome, onValueChange: (x) => setOutcome(x), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: Object.keys(OUTCOME_LABEL).map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: o, className: "text-xs", children: OUTCOME_LABEL[o] }, o)) })
      ] }) }),
      (outcome === "lost" || outcome === "not-looking") && /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Lost reason", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: lostReason, onValueChange: (x) => setLostReason(x), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: Object.keys(LOST_REASON_LABEL).map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: o, className: "text-xs", children: LOST_REASON_LABEL[o] }, o)) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Reason / context (required for loss)", value: note, onChange: (e) => setNote(e.target.value), className: "h-8 text-xs" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Next action", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: action, onChange: (e) => setAction(e.target.value), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Owner", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: owner, onChange: (e) => setOwner(e.target.value), className: "h-8 text-xs" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Deadline", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "datetime-local", value: due, onChange: (e) => setDue(e.target.value), className: "h-8 text-xs" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { className: "h-3 w-3 mr-1" }),
          "Close out visit"
        ]
      }
    )
...
function NoteComposer({ visit: v }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Controller note…", value: text, onChange: (e) => setText(e.target.value), className: "h-8 text-xs" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: "h-8 text-xs", disabled: !text, onClick: () => {
...
function AlertRail({ alerts, onOpen }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold", children: "Control Tower alerts" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-[10px]", children: [
        open.length,
        " open"
      ] })
    ] }),
    open.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "No open alerts. Every active visit is inside SLA." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5 max-h-[420px] overflow-y-auto pr-1", children: open.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("rounded-lg border p-2 flex items-start gap-2", TONE[a.severity]), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11.5px] font-medium leading-snug", children: a.message }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", className: "h-6 px-1.5 text-[10px]", onClick: () => onOpen(a.visitId), children: "Open" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", className: "h-6 px-1.5 text-[10px]", onClick: () => resolveAlert(a.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-3 w-3" }) })
      ] })
    ] }, a.id)) })
  ] });
}
function Stat({ label, value, sub }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-semibold tabular-nums", children: value }),
    sub && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10.5px] text-muted-foreground", children: sub })
  ] });
}
function MetricsPanel({ m }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Visits scheduled", value: m.scheduled }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Confirmed", value: m.confirmed }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "En route", value: m.enRoute }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Completed", value: m.completed }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "No-shows", value: m.noShows }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Rescheduled", value: m.rescheduled }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Quotations sent", value: m.quotationsSent }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Quotation TAT", value: `${m.avgQuotationTurnaroundMin}m`, sub: "feedback → quotation" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Arrival → quotation", value: `${m.avgArrivalToQuotationMin}m` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Quotation → token", value: `${m.avgQuotationToTokenMin}m` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Bookings", value: m.booked }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Same-day booking", value: `${m.sameDayBookingPct}%` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Stuck w/o next action", value: m.stuckWithoutNextAction })
    ] }),
...
function Table({ title, head, rows }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold mb-2", children: title }),
    rows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "No data yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-[11px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "text-muted-foreground text-left", children: head.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "font-medium pb-1", children: h }, h)) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rows.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-t border-border/60", children: r.map((c, j) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-1 tabular-nums", children: c }, j)) }, i)) })
    ] })
  ] });
}
const SCENARIOS = [
...
function PlaybookPanel() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold", children: "20 live tour scenarios" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-2", children: SCENARIOS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-3 space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[10px]", children: s.id }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: s.title })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: s.action }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1 pt-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-[10px]", children: s.status }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-[10px]", children: [
            "Next: ",
            s.next
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold mb-2", children: "Non-negotiable visit rules" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: RULES.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "text-[11px] text-muted-foreground", children: [
          "· ",
          r
        ] }, r)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold mb-2", children: "Team roles" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: ROLES.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-medium", children: r.role }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: r.owns.join(" · ") })
        ] }, r.role)) })
      ] })
    ] })
  ] });
...
function LiveVisitWarRoom() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex flex-wrap items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative flex h-2.5 w-2.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative rounded-full h-2.5 w-2.5 bg-success" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-semibold tracking-tight", children: "Live Visit War Room" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground max-w-xl", children: "Not a calendar. Every active customer is visible, owned, timed and pushed toward a booking, quotation, token or a documented next action." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex flex-wrap items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Search customer, property, room…", value: query, onChange: (e) => setQuery(e.target.value), className: "h-8 w-52 text-xs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: ownerFilter, onValueChange: setOwnerFilter, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 w-40 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "All owners" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", className: "text-xs", children: "All owners & coordinators" }),
            tcms.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: t.id, className: "text-xs", children: t.name }, t.id))
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScheduleVisitDialog, { onScheduled: () => toast.success("Visit scheduled and pushed into the War Room") })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(LiveTourStrip, { visits: filtered, now, onOpen: setOpenId }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 xl:grid-cols-7 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kpi, { label: "Active visits", value: filtered.filter((v) => !["booked", "lost"].includes(v.stage)).length }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kpi, { label: "Close now", value: closeNow.length, tone: "success" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kpi, { label: "At risk", value: atRisk.length, tone: "destructive" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kpi, { label: "Follow-up", value: followUp.length, tone: "warning" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kpi, { label: "Open alerts", value: openAlerts.length, tone: openAlerts.length ? "destructive" : "default" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kpi, { label: "Quotations today", value: metrics.quotationsSent }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kpi, { label: "Booked today", value: metrics.booked, tone: "success" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "board", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "h-9", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "board", className: "text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutGrid, { className: "h-3.5 w-3.5 mr-1" }),
          "War board"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "priority", className: "text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "h-3.5 w-3.5 mr-1" }),
          "Priority engine"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "alerts", className: "text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { className: "h-3.5 w-3.5 mr-1" }),
          "Alerts (",
          openAlerts.length,
          ")"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "metrics", className: "text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Gauge, { className: "h-3.5 w-3.5 mr-1" }),
          "Metrics"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "playbook", className: "text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-3.5 w-3.5 mr-1" }),
          "Playbook"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "board", className: "pt-4 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BoardRow, { cols: PRIMARY_COLUMNS, columns, now, onOpen: setOpenId }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BoardRow, { cols: SECONDARY_COLUMNS, columns, now, onOpen: setOpenId, compact: true })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "priority", className: "pt-4 grid grid-cols-1 lg:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PriorityLane, { title: "Priority 1 · Close now", hint: "Customer inside the property, rated 8+, room selected, one objection left.", tone: "success", visits: closeNow, now, onOpen: setOpenId }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(PriorityLane, { title: "Priority 2 · At risk", hint: "Late, unconfirmed, room lost, no action for 15+ minutes.", tone: "destructive", visits: atRisk, now, onOpen: setOpenId }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(PriorityLane, { title: "Priority 3 · Follow-up required", hint: "Tour done, family approval, comparison, token promised but unpaid.", tone: "warning", visits: followUp, now, onOpen: setOpenId })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "alerts", className: "pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AlertRail, { alerts, onOpen: (id) => setOpenId(id) }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "metrics", className: "pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MetricsPanel, { m: metrics }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "playbook", className: "pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PlaybookPanel, {}) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(VisitControlSheet, { visit: active, now, alternatives, coordinators, onClose: () => setOpenId(null) })
  ] });
}
function Kpi({
  label,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-2.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wide text-muted-foreground", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("text-xl font-semibold tabular-nums", toneCls), children: value })
  ] });
}
function BoardRow({
  cols,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("grid gap-3", cols.length === 5 ? "grid-cols-1 md:grid-cols-3 xl:grid-cols-5" : "grid-cols-1 md:grid-cols-3 xl:grid-cols-5"), children: cols.map((c) => {
    const list = columns.get(c) ?? [];
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-muted/20 p-2 space-y-2 min-h-[120px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-0.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10.5px] font-semibold tracking-wide text-muted-foreground", children: COLUMN_LABEL[c] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[9px]", children: list.length })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-[560px] overflow-y-auto pr-0.5", children: list.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10.5px] text-muted-foreground px-1 py-2", children: "Empty" }) : list.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsx(LiveVisitCard, { visit: v, now, onOpen, compact }, v.id)) })
    ] }, c);
  }) });
}
function PriorityLane({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: cn("p-3 space-y-2 border", border), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10.5px] text-muted-foreground", children: hint })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-[600px] overflow-y-auto pr-0.5", children: visits.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "Nothing here right now." }) : visits.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsx(LiveVisitCard, { visit: v, now, onOpen }, v.id)) })
  ] });
}
function ScheduleVisitDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-8 text-xs", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-base", children: "Schedule a visit" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground -mt-2", children: "A visit cannot be scheduled against a property alone — a room or bed preference is mandatory." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[11px]", children: "Customer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: leadId, onValueChange: setLeadId, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select lead" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: leads.slice(0, 60).map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: l.id, className: "text-xs", children: [
              l.name,
              " · ",
              l.phone
            ] }, l.id)) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[11px]", children: "Property" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: propertyId, onValueChange: setPropertyId, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Property" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: properties.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: p.id, className: "text-xs", children: p.name }, p.id)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[11px]", children: "Tour coordinator" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: tcmId, onValueChange: setTcmId, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Coordinator" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: tcms.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: t.id, className: "text-xs", children: t.name }, t.id)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[11px]", children: "Room" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: room, onChange: (e) => setRoom(e.target.value), placeholder: "204", className: "h-8 text-xs" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[11px]", children: "Bed" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: bed, onChange: (e) => setBed(e.target.value), className: "h-8 text-xs" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[11px]", children: "Date & time" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "datetime-local", value: when, onChange: (e) => setWhen(e.target.value), className: "h-8 text-xs" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "h-8 text-xs mt-2", disabled: !canSave, onClick: () => {
        ...
        setOpen(false);
        onScheduled();
      }, children: "Schedule & push to War Room" })
    ] })
  ] });
}
function LiveTourStrip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-success/40 bg-success/10 p-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "h-4 w-4 text-success animate-pulse" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground ml-auto", children: "Timers broadcast live to admin & owner feeds" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: live.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => onOpen(v.id), className: "flex items-center gap-2 rounded-lg border bg-card px-2.5 py-1.5 text-xs hover:border-success", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: v.customer }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground truncate max-w-32", children: v.propertyName }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono tabular-nums text-success", children: fmtDur(now - (v.tourStartedAt ?? now)) })
    ] }, v.id)) })
  ] });
}
const SplitComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(LiveVisitWarRoom, {}) });
export {
