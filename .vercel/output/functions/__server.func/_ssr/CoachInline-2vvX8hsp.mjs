...
import { u as useApp, c as useMountedNow, q as cn } from "./router-kYRMoTX_.mjs";
import { an as useGame, ao as buildCoachReport, ap as whoKey } from "./AppShell-Cp2f_YYK.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium truncate flex-1 text-foreground", children: message }),
        top && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[10px] text-muted-foreground shrink-0 hidden sm:inline", children: [
          "+",
          top.xp,
          " XP"
        ] }),
        stats.streak > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-0.5 text-warning font-mono text-[10px] shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "h-3 w-3" }),
          " ",
          stats.streak,
          "d"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-3.5 w-3.5 text-muted-foreground shrink-0 group-hover:translate-x-0.5 transition-transform" })
      ]
    }
  );
}
