...
import { A as AppShell, u as useQuotations } from "./AppShell-Cp2f_YYK.mjs";
import { k as Button, B as Badge, u as useApp, at as PROPERTIES, au as ACTIVITIES, av as FOLLOWUPS, aw as TOURS, ax as LEADS, ay as TCMS } from "./router-kYRMoTX_.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import "../_libs/react-dom.mjs";
import { aD as Database, g as TriangleAlert, S as Sparkles, ao as Trash2 } from "../_libs/lucide-react.mjs";
...
function DemoLoad() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] uppercase tracking-[0.2em] text-accent font-semibold flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Database, { className: "h-3 w-3" }),
        " War-room simulation"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-semibold", children: "Demo Load · 30 users × 600 leads" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Seeds a fake 30-person company (8 Lead Gen · 8 SDR · 5 Visit Coord · 4 Closers · 3 Ops · 2 Managers) and 18,000 leads with realistic segmentation, funnel distribution, duplicates, spam, no-response, refunds." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-warning/30 bg-warning/5 p-3 flex gap-2 text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4 text-warning shrink-0 mt-0.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-warning", children: "One-tap stress test." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "lg", variant: "default", className: "h-auto py-4 gap-2 flex-col items-start bg-gradient-to-br from-success to-primary", disabled: loading, onClick: () => run(50), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "QA · 50" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] opacity-80", children: "Feature test — 50 leads across every stage" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "lg", variant: "default", className: "h-auto py-4 gap-2 flex-col items-start", disabled: loading, onClick: () => run(1e3), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Light · 1K" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] opacity-80", children: "Smoke test — 30 users, 1,000 leads" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "lg", variant: "default", className: "h-auto py-4 gap-2 flex-col items-start", disabled: loading, onClick: () => run(5e3), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Medium · 5K" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] opacity-80", children: "Realistic — 30 users, 5,000 leads" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "lg", variant: "default", className: "h-auto py-4 gap-2 flex-col items-start bg-gradient-to-br from-accent to-primary", disabled: loading, onClick: () => run(18e3), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Full · 18K" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] opacity-80", children: "War-room — 30 users, 18,000 leads" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: loaded ? "bg-success/10 text-success border-success/40" : "bg-muted text-muted-foreground", children: loaded ? "Demo loaded" : "Baseline data" }),
      loaded && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", onClick: clear, className: "gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-3.5 w-3.5" }),
        " Clear demo"
      ] })
    ] }),
    loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-border bg-card p-6 text-center text-sm text-muted-foreground", children: "Seeding… this can take a few seconds for 18K." }),
    report && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border bg-card p-4 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-display font-semibold", children: "Seed complete" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-[10px]", children: [
          report.durationMs,
          "ms"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-2 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Users", value: report.tcms }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Leads", value: report.leads }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Tours", value: report.tours }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Follow-ups", value: report.followUps }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Quotations", value: report.quotes })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "By segment", data: report.bySegment }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "By stage", data: report.byStage }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "By team", data: report.byTeam }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t border-border text-xs text-muted-foreground", children: [
        "Now open ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "text-primary underline", href: "/impact", children: "/impact" }),
        ", ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "text-primary underline", href: "/war-room", children: "/war-room" }),
        ", ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "text-primary underline", href: "/funnel", children: "/funnel" }),
        " and ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "text-primary underline", href: "/leaderboard", children: "/leaderboard" }),
        " to feel the load."
      ] })
    ] })
  ] });
...
function Stat({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-border p-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-display font-semibold", children: value.toLocaleString() })
  ] });
}
function Section({
  title,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground font-semibold mb-1", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: entries.map(([k, v]) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-gradient-to-r from-primary to-accent", style: {
          width: `${pct}%`
        } }) })
      ] }, k);
    }) })
...
const SplitComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DemoLoad, {}) });
export {
