...
import { aC as useAppState, aN as useTourData, C as Card, aq as CardHeader, ar as CardTitle, ap as CardContent, q as cn, U as Label, A as Textarea, k as Button } from "./router-Brs45mHz.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { bC as ArrowLeft } from "../_libs/lucide-react.mjs";
...
function CustomerFeedbackPage() {
  ...
  if (!tour) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6", children: "Tour not found." });
  function submit() {
    if (!sentiment || !id) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl mx-auto space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: OPTS.map((o) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl", children: o.emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium mt-1", children: o.label })
            ]
          },
          o.v
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "c", children: "Tell us more (optional)" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: submit, disabled: !sentiment, className: "w-full", children: submitted ? "Update feedback" : "Submit feedback" }),
        submitted && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground border rounded p-2 bg-muted/30", children: "✅ Recorded. The team will reach out with refined options shortly." })
      ] })
    ] })
  ] });
}
